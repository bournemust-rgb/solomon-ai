...
function buildMenu(OFFICE_NUMBER, OFFICE_EMAIL, QUOTE_EMAIL, FACEBOOK, TIKTOK, GOOGLE_REVIEW, TERMS_URL) {
  var QR = {
    ...
    "pricing": "PRICING (excl VAT)\n\nRims: R1000-R1500 set of 10 inch - 15 inch, colour black and white, R1300 - R1700 other colours | Rims sized 16 inch - 18 inch R1500 - R1800 black and white, other colours R1700 - R2200\n\nSheet metal: R175-R350/sqm +-\n\nCoating: R16/kg Black and white, R17-R20/kg other colours (gates, burglar bars, fencing etc)\n\nBlasting: R8-R12/kg or R250 per square meter\n\nTruck 3-5m: R5000-R7500 (Tippers, close trucks or any other truck types are to be priced individually)\n\nMin Charge for coating: R200 excl VAT\n\nAll the above prices are estimates based on certain criteria based on stock and material conditions. Contact Ridhor directly on 076 760 4350 for a closer approximation. Thank you.\n\nType *menu* to go back to the main list.",
