...
if ((t.includes("gate") || t.includes("fence") || t.includes("burglar") || t.includes("security")) && !hasWeight) {
  ...
  if (normal && !normal.includes("Secret List") && !normal.includes("Type *S2*") && !normal.includes("Reply with *C*") && !normal.includes("11.Review") && !normal.includes("Or just tell me what you need priced")) {
    normal = normal + "\n\nType *menu* to go back to LIST.";
  }
  return normal;
}
